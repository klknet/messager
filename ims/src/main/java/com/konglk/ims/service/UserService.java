...
public class UserService
{
  ...
  public UserDO login(String unique, String pwd)
  {
    ...
    query.addCriteria(new Criteria().orOperator(new Criteria[] { Criteria.where("username").is(unique), 
  ...
  public void addUser(UserDO user)
  {
    ...
    this.logger.debug("add new user {}", user.getUsername());
  }
  ...
  public UserDO addFriend(String userId, String destId, String remark)
  {
    ...
    return (UserDO)this.mongoTemplate.findAndModify(query, update, UserDO.class);
  }
}
